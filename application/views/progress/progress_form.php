 ...
 ?>
     ...
     <input class="input-textarea"
     type="file" id="picture_01" name="files[]"/>
     <br/>
     <label for="picture_01_caption">Caption:</label>
     <input class="input-textarea"
     type="text" id="picture_01_caption" name="picture_01_caption"/>
     <br/>
     <label for="picture_02">Upload Picture:</label>
     <input class="input-textarea"
     type="file" id="picture_02" name="files[]"/>
     <br/>
     <label for="picture_02_caption">Caption:</label>
     <input class="input-textarea"
     type="text" id="picture_02_caption" name="picture_02_caption"/>
     <br/>
     <label for="picture_03">Upload Picture:</label>
     <input class="input-textarea"
     type="file" id="picture_03" name="files[]"/>
     <br/>
     <label for="picture_03_caption">Caption:</label>
     <input class="input-textarea"
     type="text" id="picture_03_caption" name="picture_03_caption"/>
     <br/>
     <label for="picture_04">Upload Picture:</label>
     <input class="input-textarea"
     type="file" id="picture_04" name="files[]"/>
     <br/>
     <label for="picture_04_caption">Caption:</label>
     <input class="input-textarea"
     type="text" id="picture_04_caption" name="picture_04_caption"/>
     <br/>
     <label for="picture_05">Upload Picture:</label>
     <input class="input-textarea"
     type="file" id="picture_05" name="files[]"/>
     <br/>
     <label for="picture_05_caption">Caption:</label>
     <input class="input-textarea"
     type="text" id="picture_05_caption" name="picture_05_caption"/>
     <br/>
     <label for="picture_06">Upload Picture:</label>
     <input class="input-textarea"
     type="file" id="picture_06" name="files[]"/>
     <br/>
     <label for="picture_05_caption">Caption:</label>
     <input class="input-textarea"
     type="text" id="picture_06_caption" name="picture_06_caption"/>
     <br/>
